...
\begin{enumerate}
  \item {
    ...
    einer Grammatik mit \textbf{minimaler} Anzahl an:
  ...
  \item {
    ...
    \begin{enumerate}
      ...
      \statement{
        Ein minimaler NFA hat höchstens so viele Zustände wie ein äquivalenter
        DFA, der die gleiche Sprache entscheidet, mit minimaler Anzahl an Zuständen.
      }
      \statement{
        Jede Sprache, die nur Wörter der Länge $k \in \mathbb{N}$ akzeptiert,
        ist regulär.
      }
      \statement{
